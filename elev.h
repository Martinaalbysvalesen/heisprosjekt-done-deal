...
/**
  Function for converting buttontype to direction
 */
int elev_dirn_to_button(elev_motor_direction_t direction);
int elev_button_to_dirn(elev_button_type_t button);
...
/* sets all lights to "off = 0" */
void elev_cancel_all_lights();
